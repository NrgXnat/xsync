...
public class XsyncEditExperimentUserAuthorizer extends AbstractXapiAuthorization {
    ...
    protected boolean checkImpl(AccessLevel accessLevel, JoinPoint joinPoint, UserI user, HttpServletRequest request) {
        try {
            ...
            return (Permissions.canEdit(user, expData) || Roles.checkRole(user, XsyncUtils.XSYNC_ADMINISTRATOR_ROLE));
        } catch (Exception e) {
