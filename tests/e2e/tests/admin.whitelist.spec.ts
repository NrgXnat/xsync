...
test.describe('@admin XSync destination whitelist', () => {
    ...
    test('PLUGINS-332: a url posted with a trailing slash is stored without one', async () => {
        // The fix in commit 2911713 normalises the url in the admin dialog.
        // This is the same requirement reached over REST, which the admin UI
        // itself uses and which the startup bootstrap file goes through.
        // Ian to confirm whether normalisation is meant to reach this path.
        const trailing: WhitelistSite = {
